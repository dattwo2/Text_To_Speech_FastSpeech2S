...
function Ji(e, n, t) {
	...
	return { $$typeof: Xt, type: e, key: o, ref: u, props: l, _owner: Ao.current };
}
function vc(e, n) {
...
var ie = { current: null },
	wr = { transition: null },
	wc = { ReactCurrentDispatcher: ie, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Ao };
T.Children = {
	map: nr,
		...
		(e.unstable_scheduleCallback = function (x, P, z) {
			...
			return (
				...
				z > W
					? ((x.sortIndex = z),
					  n(c, x),
					  t(s) === null && x === t(c) && (S ? (f(N), (N = -1)) : (S = !0), yl(v, z - W)))
...
var We = !(
	...
	Uu = {};
function zc(e) {
	return Kl.call(Uu, e) ? !0 : Kl.call(Fu, e) ? !1 : Pc.test(e) ? (Uu[e] = !0) : ((Fu[e] = !0), !1);
}
function Tc(e, n, t, r) {
...
function bo(e, n, t, r) {
	if (Dr) {
		...
		if (l === null) Ml(e, n, r, Ir, t), Yu(e, r);
			...
			for (; l !== null; ) {
				var o = Jt(l);
				if ((o !== null && Ts(o), (o = co(e, n, t, r)), o === null && Ml(e, n, r, Ir, t), o === l))
					break;
				l = o;
			}
	...
	Ss(function () {
			...
			if (p !== void 0) {
				...
				for (var a = c, d; a !== null; ) {
					...
					if (
						(d.tag === 5 &&
							v !== null &&
							((d = v), f !== null && ((v = jt(a, f)), v != null && S.push(Vt(a, v, d)))),
						I)
					)
						break;
					a = a.return;
		...
		if (!(n & 7)) {
				...
				if (
					...
					g
						? ((w = t.relatedTarget || t.toElement),
						  (g = c),
						  (w = w ? kn(w) : null),
						  w !== null && ((I = On(w)), w !== I || (w.tag !== 5 && w.tag !== 6)) && (w = null))
						: ((g = null), (w = c)),
					g !== w)
				) {
					if (
						...
						(e === 'pointerout' || e === 'pointerover') &&
							((S = qu), (v = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
						(I = g == null ? p : $n(g)),
						(d = w == null ? p : $n(w)),
			...
			switch (((C = c ? $n(c) : window), e)) {
				case 'focusin':
					(ni(C) || C.contentEditable === 'true') && ((Fn = C), (fo = c), (Nt = null));
					break;
				case 'focusout':
					Nt = fo = Fn = null;
					break;
			...
			N &&
				(Is &&
					...
					(In || N !== 'onCompositionStart'
						...
						: ((nn = h), (eu = 'value' in nn ? nn.value : nn.textContent), (In = !0))),
				(C = Fr(c, N)),
				0 < C.length &&
	...
	if (U) {
		...
		if (n) {
			...
			if (!hi(e, n)) {
				...
				n = un(t.nextSibling);
				var r = ve;
				n && hi(e, n) ? na(r, t) : ((e.flags = (e.flags & -4097) | 2), (U = !1), (ve = e));
			}
		} else {
			if (So(e)) throw Error(y(418));
	...
	if (((e = t.ref), e !== null && typeof e != 'function' && typeof e != 'object')) {
		if (t._owner) {
			...
			return n !== null && n.ref !== null && typeof n.ref == 'function' && n.ref._stringRef === o
				...
				: ((n = function (u) {
						var i = l.refs;
						i === oa && (i = l.refs = {}), u === null ? delete i[o] : (i[o] = u);
				  }),
				  (n._stringRef = o),
				  n);
		}
...
function ia(e) {
	...
	function w(f, a, d, v) {
		...
		if (_ === null) {
			for (; N < d.length; N++)
				(_ = m(f, d[N], v)),
					_ !== null && ((a = o(_, a, N)), C === null ? (E = _) : (C.sibling = _), (C = _));
			return U && wn(f, N), E;
		}
	...
	function S(f, a, d, v) {
		...
		for (
			var C = (E = null), _ = a, N = (a = 0), H = null, L = d.next();
			_ !== null && !L.done;
			N++, L = d.next()
		) {
			_.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
		...
		if (_ === null) {
			for (; !L.done; N++, L = d.next())
				(L = m(f, L.value, v)),
					L !== null && ((a = o(L, a, N)), C === null ? (E = L) : (C.sibling = L), (C = L));
			return U && wn(f, N), E;
		}
						...
						for (var E = d.key, C = a; C !== null; ) {
							if (C.key === E) {
								if (((E = d.type), E === Dn)) {
									...
									C.elementType === E ||
									(typeof E == 'object' && E !== null && E.$$typeof === Ze && ki(E) === C.type)
								) {
									t(f, C.sibling),
										(a = l(C, d.props)),
										(a.ref = ht(f, C, d)),
	...
	if (l !== null) {
		...
		do {
			...
			if ((zn & h) === h)
				...
				s === null ? ((i = s = m), (u = r)) : (s = s.next = m), (V.lanes |= h), (Tn |= h);
			}
			c = c.next;
		} while (c !== null && c !== o);
		s === null ? (u = r) : (s.next = i),
...
function Ca(e, n, t) {
	return zn & 21
		? (je(t, n) || ((t = Ps()), (V.lanes |= t), (Tn |= t), (e.baseState = !0)), n)
...
function zi(e, n, t, r, l) {
	...
	if (((o = e.child), !(e.lanes & l))) {
		...
		if (((t = t.compare), (t = t !== null ? t : Ut), t(u, r) && e.ref === n.ref))
			return Ye(e, n, l);
	}
...
function Oa(e, n, t) {
	...
	if (r.mode === 'hidden')
		...
		o !== null ? ((r = o.baseLanes | t), (n.memoizedState = null)) : (r = t), j(Qn, me), (me |= r);
					...
					for (var u in o)
						if (o.hasOwnProperty(u)) {
							...
							u === 'children'
								? typeof i == 'string'
									? r.textContent !== i &&
									  (o.suppressHydrationWarning !== !0 && fr(r.textContent, i, e),
									  (l = ['children', i]))
									: typeof i == 'number' &&
									  r.textContent !== '' + i &&
									  (o.suppressHydrationWarning !== !0 && fr(r.textContent, i, e),
									  (l = ['children', '' + i]))
								: Rt.hasOwnProperty(u) && i != null && u === 'onScroll' && M('scroll', r);
						}
					switch (t) {
						case 'input':
							rr(r), Au(r, o, !0);
...
function cd(e, n) {
	switch ((uu(n), n.tag)) {
		case 1:
			return (
				de(n.type) && $r(), (e = n.flags), e & 65536 ? ((n.flags = (e & -65537) | 128), n) : null
			);
		case 3:
			return (
				tt(),
...
function Va(e) {
	...
	n !== null && ((e.alternate = null), Va(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null && (delete n[Ie], delete n[At], delete n[go], delete n[Xf], delete n[Gf])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function Ha(e, n) {
	...
	switch (e.tag) {
		...
		case 1:
			...
			break;
		case 5:
			if ((Pe(n, e), Me(e), r & 512 && t !== null && Wn(t, t.return), e.flags & 32)) {
				var l = e.stateNode;
				try {
					Ot(l, '');
				} catch (S) {
		...
		case 13:
			Pe(n, e),
				...
				l.flags & 8192 &&
					...
					!o || (l.alternate !== null && l.alternate.memoizedState !== null) || (Cu = Q())),
				r & 4 && Mi(e);
			break;
		case 22:
			if (
	...
	if (n !== 0) {
		...
		if (n === 6) en(e, r);
			...
			if (
				...
				!(r & 30) &&
					!hd(l) &&
					((n = qr(e, r)), n === 2 && ((o = so(e)), o !== 0 && ((r = o), (n = Fo(e, o)))), n === 1))
			)
				throw ((t = Yt), Cn(e, 0), en(e, r), pe(e, Q()), t);
...
function en(e, n) {
	for (
		n &= ~xu, n &= ~cl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
		0 < n;
...
function Ui(e) {
	...
	return (
		(e.finishedWork = e.current.alternate), (e.finishedLanes = n), Sn(e, ae, $e), pe(e, Q()), null
	);
}
function _u(e, n) {
	var t = R;
		...
		try {
			...
			e: {
				...
				if (
					...
					var g = _i(u);
					if (g !== null) {
						(g.flags &= -257), Ni(g, u, i, o, n), g.mode & 1 && Ci(o, c, n), (n = g), (s = c);
						var w = n.updateQueue;
						if (w === null) {
							var S = new Set();
					...
					var I = _i(u);
					if (I !== null) {
						!(I.flags & 65536) && (I.flags |= 256), Ni(I, u, i, o, n), iu(rt(s, i));
						break e;
					}
				}
...
function Xa(e) {
	...
	(e.memoizedProps = e.pendingProps), n === null ? Ga(e) : (K = n), (Eu.current = null);
}
function Ga(e) {
	var n = e;
	do {
...
function Jn() {
	if (tn !== null) {
		var e = zs(Jr),
			...
			t = O;
		try {
			if (((xe.transition = null), (O = 16 > e ? 16 : e), tn === null)) var r = !1;
			else {
...
function wd(e, n, t) {
	...
	r !== null && r.delete(n),
		...
		J === e &&
			(b & t) === t &&
			(X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - Cu) ? Cn(e, 0) : (xu |= t)),
		pe(e, n);
}
function Za(e, n) {
	...
	switch (((n.lanes = 0), n.tag)) {
		...
		case 3:
			e: {
				...
				(r = n.pendingProps), (o = n.memoizedState), (l = o.element), la(e, n), Qr(n, r, null, t);
...
function fl(e, n, t, r) {
	return (
		(e = Ee(22, e, r, n)), (e.elementType = is), (e.lanes = t), (e.stateNode = { isHidden: !1 }), e
	);
}
function Hl(e, n, t) {
...
gs = _u;
ws = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, vs, ys, _u] },
	yt = {
...
const Rd = { 0: 'very_slow', 25: 'slow', 50: 'normal', 75: 'fast', 100: 'very_fast' };
function Od() {
	const e = qe.useRef(),
		[n, t] = qe.useState(50),
		[r, l] = qe.useState(''),
		[o, u] = qe.useState(!1),
		[i, s] = qe.useState(null);
	qi.useEffect(() => {
		if (o) {
			var g = { method: 'GET', redirect: 'follow' };
			fetch('http://' + window.location.host + '/tts?text=' + r + '&speed=' + Rd[n], g)
				.then((w) => w.json())
				.then((w) => {
					s(w), c();
				})
	...
	const c = () => {
			e.current && (e.current.pause(), e.current.load());
		},
		h = (g) => {
			l(g.target.value);
		},
			...
			children: F.jsxs('div', {
				...
				children: [
					F.jsx('h1', {
						...
						children: 'Text To Speech in Vietnamese',
					}),
					F.jsx('p', {
						className: 'text-sm',
						children: 'Công cụ chuyển đổi văn bản thành giọng nói',
					}),
					F.jsx('textarea', {
						id: 'textarea',
						value: r,
						className:
							' pt-3 textarea textarea-bordered textarea-md w-screen max-w-xs textarea-info',
						placeholder: 'Nhập văn bản...',
						onChange: h,
					}),
					F.jsx('p', { className: 'text-sm font-medium', children: 'Tốc độ' }),
					F.jsx('input', {
						type: 'range',
						min: 0,
						max: '100',
					...
					F.jsxs('div', {
						className: 'w-full flex justify-between text-xs px-2 pb-3',
						children: [
							F.jsx('span', { className: 'font-medium', children: 'Chậm' }),
							F.jsx('span', { children: '|' }),
							F.jsx('span', { className: 'font-medium', children: 'Vừa' }),
							F.jsx('span', { children: '|' }),
							F.jsx('span', { className: 'font-medium', children: 'Nhanh' }),
						],
					}),
					F.jsx('div', {
						...
						children: F.jsx('button', {
							...
							children: o
								? F.jsx('span', { className: 'loading loading-dots loading-sm' })
								: 'Chuyển đổi',
						}),
					}),
					i &&
						F.jsxs('div', {
							...
							children: [
								F.jsx('span', { className: 'font-medium mt-3', children: 'Kết quả' }),
								F.jsxs('audio', {
									controls: !0,
									ref: e,
									children: [
										F.jsx('source', { src: i.audio_url, type: 'audio/wav' }),
...
Ql.createRoot(document.getElementById('root')).render(
	F.jsx(qi.StrictMode, { children: F.jsx(Od, {}) })
);
